...
sed -i -e 's/REDIS_ENDPOINT/10.1.0.6/' -e 's/CATALOGUE_ENDPOINT/10.1.0.8/' -e 's/MONGO_ENDPOINT/10.1.0.5/' -e '/s/MONGO_DNSNAME/10.1.0.5/' /home/roboshop/${COMPONENT}/systemd.service &>>${LOG_FILE}
